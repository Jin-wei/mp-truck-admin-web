...
exports.initSelect2Remote = function (jqItem, url) {
    jqItem.select2({
        language: "zh-CN",
        maximumSelectionLength: 1,
        ajax: {
...
exports.initSelect2PlaceholderNoWidth = function (jqItem, sdata, placeholder) {
    jqItem.select2({
        maximumSelectionLength: 1,
        language: 'zh-CN',
        tags: false,
...
exports.initDatepickerMonth = function (jqItem) {
    jqItem.datepicker({
        language: 'zh-CN',
        autoclose: true,
        todayHighlight: true,
    ...
    exports.dealConfrimCommon(msg, function () {
        _self.$http.post(apiUrl, row).then((response) => {
            if (response.data.errno == 0) {
                ...
                exports.dealWarningCommon(response.data.msg);
            }
...
exports.BTRowFormatFooter = function (rowid, rowname, footerFormatter) {
    return {
        field: rowid,
        title: rowname,
        class: 'text-nowrap',
...
exports.getSystemName = function () {
    let systemName = '车队云管家';
    let hostName = window.location.hostname;
    hostName = hostName.replace(/www./, '');
    let splitArray = hostName.split('.');
    if (splitArray[0] === 'huateng') {
        systemName = '华腾云管家';
        //华腾样式
