                    ...
                    <form @submit.prevent="addDm" id="formA">
                        <div class="modal-body row">
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" v-model="workRow.domain" data-parsley-required="true"
                                           maxlength="50" data-parsley-maxlength="50">
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                <label class="col-sm-2 control-label">机构模板</label>
                                <div class="col-sm-10">
                                    <select class="form-control select2" multiple id="domaintemplate_id"
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" v-model="workRow.domain_name"
                                           data-parsley-required="true" maxlength="50" data-parsley-maxlength="50">
                                </div>
                            </div>
                            <div class="form-group col-sm-12 m_ll">
                                <div data-toggle="distpicker" id="distpicker">
                                    <div class="col-sm-4">
                                        <span class="col-sm-3 control-label font-style">省</span>
                                        <div class="col-sm-9">
                                            <select class="form-control picker-width" id="domain_province"
                                                    data-parsley-required="true"></select>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 p_r margin_left">
                                        <span class="col-sm-5 control-label font-style">市/县</span>
                                        <div class="col-sm-9 m_l">
                                            <select class="form-control picker-width" id="domain_city"
                                                    data-parsley-required="true" style="width:90px;"></select>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <span class="col-sm-3 control-label font-style">区</span>
                                        <div class="col-sm-9">
                                            <select class="form-control picker-width" id="domain_district"
                                                    data-parsley-required="true"></select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" v-model="workRow.domain_address"
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control " v-model="workRow.domain_contact"
                                           data-parsley-required="true" maxlength="50" data-parsley-maxlength="50">
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" v-model="workRow.domain_phone"
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-10 left-padding">
                                    <input class="form-control" v-model="workRow.domain_description" maxlength="100"
                        ...
                        <div class="col-md-7">
                            <div class="col-md-1 modal-height vertical-container">
                                <div class="btn-group-vertical">
                                    <button type="button" class="btn btn-primary btn-icon" @click="addMenu"><i
                    ...
                    <form class="form-horizontal" @submit.prevent="submitF" id="formF">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" v-model="workRow.domainmenu_name"
                                           data-parsley-required="true" maxlength="50" data-parsley-maxlength="50">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                      ...
                                      <button type="button" class="btn btn-info" data-toggle="modal"
                                              data-target="#modalTable" @click="showIcon">
...
//                        height: common.getTableHeight(),
                        columns: [
                            ...
                            common.BTRowFormatEditable('domain_address', '地址'),
                            common.BTRowFormatEditable('domain_contact', '联系人'),
                            common.BTRowFormatEditable('domain_phone', '联系方式'),
                            common.BTRowFormatEditablePop('domain_description', '描述'),
                        ...
                        onEditableSave: function (field, row, oldValue, $el) {
                            common.rowModifyWithT(_self, apiUrl + 'm', row, 'domain_id', $table)
                        }
                    });
...
//                    _self.workRow.domaintemplate_id = common.getSelect2Val('domaintemplate_id');
                        ...
                        let response = await
                        _self.$http.post(apiUrl + 'a', _self.workRow);
                        let retData = response.data.info;
            ...
            submitF: async function (event) {
                ...
                try {
                    if ($('#formF').parsley().isValid()) {
                        ...
                        if (_self.act === '1') {
                            let response = await
                            _self.$http.post(apiUrl + 'addFolder', _self.workRow);
                        } else {
                            let response = await
                            _self.$http.post(apiUrl + 'modifyFolder', _self.workRow);
                        }
                        $('#FModal').modal('hide');
                        _self.getDoaminMenu(_self.aSEFctDomain.domain_id);
                    }
                } catch (error) {
                    common.dealErrorCommon(_self, error);
                }
            ...
            addMenu: async function (event) {
                ...
                try {
                    ...
                    let response = await
                    _self.$http.post(apiUrl + 'addMenus', {
            ...
            deleteSelect: async function (treeNode, event) {
                ...
                try {
                    let response = await
                    _self.$http.post(apiUrl + 'deleteSelect', {
