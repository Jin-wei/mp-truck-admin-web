                            ...
                            <div class="vertical-box-column">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="col-md-11">
                                        <h5>模板功能</h5>
                                        <div class="btn-group">
                                            <a class="btn btn-default buttons-copy buttons-html5 btn-xs"
                                               @click="addF"><span>增加目录</span></a>
                                        </div>
                                        <div>
                    ...
                    <form class="form-horizontal" @submit.prevent="submitT" id="formT">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" v-model="workRow.domaintemplate_name"
                    ...
                    <form class="form-horizontal" @submit.prevent="submitF" id="formF">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" v-model="workRow.templatemenu_name"
                                           data-parsley-required="true" maxlength="50" data-parsley-maxlength="50">
                                </div>
                            </div>
                            <div class="form-group">
