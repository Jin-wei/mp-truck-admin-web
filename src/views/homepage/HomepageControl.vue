    ...
    <div class="page-container">
        <div id="home" class="header-container">
            ...
            <div class="menu-container">
                <ul>
                    ...
                    <li id="li-article"><a href="javascript:;" v-bind:class="{'menu-normal': tabIndex != 6,'menu-selected': tabIndex == 6 }" @click="gotoArticle">新闻资讯</a></li>
        ...
        <div id="search" class="search-container">
            ...
            <div class="input-group">
                <input class="search-input" type="text" placeholder="请输入SO号" v-model="order_so_code">
        ...
        <div class="scene-container">
            ...
            <div class="scene-swiper-container">
                ...
                <div class="scene-swiper-pagination swiper-pagination-white"></div>
            </div>
        </div>
        ...
        <div class="copy-right">
            <span>© 2017 美森博多利（大连）科技有限公司 版权所有 辽ICP备14014383号-7</span>
        </div>
...
<script>
    ...
    export default {
        ...
        mounted: function() {
            ...
            if (common.isMobile()) {
                _self.$router.replace('/homepage/mobile');
