<template>
    <div class="page-container">
        <div>
            <el-carousel :interval="2000" arrow="always" height="224px" indicator-position="none">
                <el-carousel-item>
        ...
        <div id="center" class="center-container">
            <div class="container-title">
                <img src="/static/images/homepage/mobile/m_center_title.png" alt="center title image">
            </div>
            <div class="center-body">
                ...
                <div class="desc">
                    ...
                    <div class="center-content">
                        <p>车队云管家是一套基于云的TMS（Transportation Management System）系统，它能
                            够帮助车企有效管理车辆、司机、客户、订单、账单信息，实现订单分配智能化，运输过
                            程可视化，财务对账电子化，服务业绩透明化。车队云管家专有的大数据算法将大幅提高
                            车企的运营管理效率，不但对自有车辆提供了绩效动力，而且还吸引挂靠车辆上平台找单
                            做，在不增加重资产的前提下，扩大了车企的业务规模。
                        </p>
            ...
            <div class="center-bottom row">
                <div class="container-title row">
                    <img src="/static/images/homepage/mobile/m_center_function.png" alt="center function">
                </div>
                <div class="center-function row">
                    <div class="row">
                        <div class="list-container col-sm-4 col-xs-4">
                            <img class="icon" src="/static/images/homepage/center_function_order.png" alt="">
                            <div class="desc-list">
                                <ul>
                                    <li>订单管理</li>
                                    <li>调度分配</li>
                        ...
                        <div class="list-container col-sm-4 col-xs-4">
                            <img class="icon" src="/static/images/homepage/center_function_location.png" alt="">
                            <div class="desc-list">
                                <ul>
                                    <li>行车管理</li>
                                    <li>卫星定位跟踪</li>
                        ...
                        <div class="list-container col-sm-4 col-xs-4">
                            <img class="icon" src="/static/images/homepage/center_function_setting.png" alt="">
                            <div class="desc-list">
                                <ul>
                                    <li>车辆管理</li>
                                    <li>人员管理</li>
                    ...
                    <div class="row">
                        <div class="list-container col-sm-4 col-xs-4">
                            <img class="icon" src="/static/images/homepage/center_function_wechat.png" alt="">
                            <div class="desc-list">
                                <ul>
                                    <li>微信端接单</li>
                                    <li>消息推送</li>
                        ...
                        <div class="list-container col-sm-4 col-xs-4">
                            <img class="icon" src="/static/images/homepage/center_function_category.png" alt="">
                            <div class="desc-list">
                                <ul>
                                    <li>系统管理</li>
                                    <li>财务对账</li>
            ...
            <div class="scene-container">
                <el-carousel :interval="2000" arrow="always" height="200px" indicator-position="none">
                    <el-carousel-item class="row">
                        <div class="swiper-content-left col-sm-6 col-xs-12">
                            <img src="/static/images/homepage/scene_icon1.png" alt="">
                            <div>
                        ...
                        <div class="swiper-content-left col-sm-6 col-xs-12">
                            <img src="/static/images/homepage/scene_icon2.png" alt="">
                            <div>
                    ...
                    <el-carousel-item class="row">
                        <div class="swiper-content-left col-sm-6 col-xs-12">
                            <img src="/static/images/homepage/scene_icon3.png" alt="">
                            <div>
                        ...
                        <div class="swiper-content-left col-sm-6 col-xs-12">
                            <img src="/static/images/homepage/scene_icon4.png" alt="">
                            <div>
                    ...
                    <el-carousel-item>
                        <div class="swiper-content-left col-sm-6 col-xs-12" style="margin-left: 10px">
                            <img src="/static/images/homepage/scene_icon5.png" alt="">
                            <div>
                        ...
                        <div class="swiper-content-left col-sm-6 col-xs-12" style="margin-left: 10px">
                            <img src="/static/images/homepage/scene_icon6.png" alt="">
                            <div>
                                <p>通过车辆轨迹，实时位置以及电子围栏功能等技术，
                                    可以通过微信提醒和短信功能给司机推送重要节点
                                    的提示信息，使司机的工作更规范化。</p>
                            </div>
                        </div>
                    </el-carousel-item>
                    <el-carousel-item>
                        <div class="swiper-content-left col-sm-6 col-xs-12">
                            <img src="/static/images/homepage/scene_icon7.png" alt="">
                            <div>
        ...
        <div id="advantage" class="advantage-container row">
            <div class="container-title">
                <img class="title-size" src="/static/images/homepage/advantage.png" alt="advantage">
            </div>
            <div class="advantage-list">
                <div class="advantage-block col-sm-4 col-xs-4">
                    <div class="container-title">
                        <img class="advantage-icon-size" src="/static/images/homepage/advantage_network.png" alt="">
                    </div>
                    <div class="desc">
                ...
                <div class="advantage-block col-sm-4 col-xs-4">
                    <div class="container-title">
                        <img class="advantage-icon-size" src="/static/images/homepage/advantage_money.png" alt="">
                    </div>
                    <div class="desc">
                ...
                <div class="advantage-block col-sm-4 col-xs-4">
                    <div class="container-title">
                        <img class="advantage-icon-size" src="/static/images/homepage/advantage_wechat.png" alt="">
                    </div>
                    <div class="desc">
        ...
        <div id="free" class="free-container row">
            <div class="container-title">
                <img class="free-title-size" src="/static/images/homepage/free.png" alt="free title">
            </div>
        ...
        <div id="about" class="footer-container row">
            <div class="company-wechat col-sm-3 col-xs-3">
                <div>
                    <img class="company-wechat-icon" src="/static/images/homepage/about_wechat_1.png" alt="">
                </div>
                <div class="wechat">
                    <span>微信公众号</span>
                </div>
            </div>
            <div class="company-container col-sm-9 col-xs-9">
                <div>
                    <span>公司地址: 辽宁省大连市高新园区晟辉大厦605室</span>
                </div>
                <div class="info">
                    <span>公司主页: http://www.missionpublic.com/cn/</span>
                </div>
                <div class="info">
        ...
        <div class="copy-right">
            <p>© 2017 美森博多利（大连）科技有限公司</p>
            <p>版权所有 辽ICP备14014383号-7</p>
        </div>
        ...
        function initTable() {
            $table.bootstrapTable({
                columns: [
                    ...
                    common.BTRowFormat('order_so_code', 'SO号'),
...
<style scoped>
    ...
    .banner-first-container {
        ...
        height: 100%;
        width: 100%;
        background-image: url(/static/images/homepage/mobile/m_banner_bg_1.jpg);
    ...
    .banner-second-container {
        ...
        width: 100%;
        height: 100%;
        background-image:url(/static/images/homepage/mobile/m_banner_bg_2.jpg);
        background-size:100% 100%
    }
    ...
    .banner-third-container {
        ...
        width: 100%;
        height: 100%;
        background-image:url(/static/images/homepage/mobile/m_banner_bg_3.jpg);
        background-size:100% 100%
    }
    ...
    .search-container {
        ...
        padding: 0px;
        background-image:url(/static/images/homepage/mobile/m_search_bg.jpg);
        height: 100px;
    }
